...
class Menu:
    ...
    MenuPrimary = f"""
{brak}[{num}1{brak}]{text} Ch4120N DNS                        {brak}[{num}9{brak}]{text} OpenDNS Home               {brak}[{num}17{brak}]{text} Yandex DNS            {brak}[{num}97{brak}]{text} Custom
{brak}[{num}2{brak}]{text} Charon Security Agency V1          {brak}[{num}10{brak}]{text} Cloudflare DNS            {brak}[{num}18{brak}]{text} DNS.Watch             {brak}[{num}98{brak}]{text} Deafult (DHCP)
{brak}[{num}3{brak}]{text} Charon Security Agency V2          {brak}[{num}11{brak}]{text} Comodo Secure DNS         {brak}[{num}19{brak}]{text} Level 3 DNS           {brak}[{num}99{brak}]{text} Exit
